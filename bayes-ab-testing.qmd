...
It'll be rigged though, as we'll already know the click-through rates for control and treatment.
...
::: columns
::: {.column width="60%"}
Let's draw a very large number of random samples from our posterior distributions to make inferences about the experiment.
