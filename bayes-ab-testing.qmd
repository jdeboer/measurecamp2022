...
We've now collected more data, so let's again update our priors to form new posteriors for the click-through rate of each group.
...
We've now observed a total sample of `r with(experiment_data_df, sum(clicked, not_clicked))` users and a decision is made to end the experiment.
