...
3.  The objective of the game is for contestants to estimate Y by requesting the host to perform step 2 as many times as they need. The closer their guess is, the better. However, each contestant can only call out their guess once.
