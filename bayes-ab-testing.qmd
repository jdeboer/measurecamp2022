...
::: columns
::: {.column width="40%"}
We express our prior beliefs about the click-through rate of control group using a **probability distribution**.
...
Calculate v, a temporary variable, using this formula:
v = (𝜇 ✕ [1 - 𝜇] ÷ 𝜎2) - 1
From there, we can now derive the 𝛼 and 𝛽 parameters:
𝛼 = 𝜇 ✕ v
𝛽 = (1 - 𝜇) ✕ v
...
Posteriors represent your updated prior beliefs once you've incorporated experiment data. Like priors, posteriors represent your new beliefs about the parameter of interest, which in our case is click-through rate.
...
-   Start the experiment, gather data, and update your priors to form posteriors about the parameter of interest
